...
import static io.smallrye.bayesian.GraphTest.assertLinkedNode;
import static io.smallrye.bayesian.GraphTest.assertLinkedVertex;
import static io.smallrye.bayesian.GraphTest.bitSet;
import static io.smallrye.bayesian.GraphTest.connectChildToParents;
import static io.smallrye.bayesian.GraphTest.connectParentToChildren;
...
public class JunctionTreeBuilderTest {
    ...
    public void testMapNodeToCliques() {
        ...
        tbuilder.mapVarNodeToCliques(nodeToCliques, 0, clique0, 3);
        tbuilder.mapVarNodeToCliques(nodeToCliques, 1, clique1, 3);
        tbuilder.mapVarNodeToCliques(nodeToCliques, 2, clique2, 3);
    ...
    public void testMapNodeToClique() {
        ...
        OpenBitSet[] nodeToCliques = new OpenBitSet[8];
        tbuilder.mapVarNodeToCliques(nodeToCliques, 0, clique0, 4);
        tbuilder.mapVarNodeToCliques(nodeToCliques, 1, clique1, 4);
        tbuilder.mapVarNodeToCliques(nodeToCliques, 2, clique2, 4);
        tbuilder.mapVarNodeToCliques(nodeToCliques, 3, clique3, 4);
